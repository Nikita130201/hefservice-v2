...
const FAQ = [
  ...
  { q: "Можно ли сдать б/у SIM-карты?", a: "Да, это возможно. Важно, чтобы карты регистрировались в сети, позволяли совершать исходящие звонки/СМС и имели положительный баланс." },
