...
function ContactCard({ icon, title, children, href, cta, target, delay = 0, color }) {
...
export default function ContactContent() {
  return (
    <section className="max-w-6xl mx-auto px-4 my-10 md:my-14">
      {/* Шапка */}
      <Reveal once>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <ContactCard
          ...
          color="rgba(59,130,246,.45)" // синий
        >
        ...
        <ContactCard
          ...
          color="rgba(168,85,247,.45)" // фиолетовый
        >
        ...
        <ContactCard
          ...
          color="rgba(34,197,94,.45)" // зелёный
        >
          sim@hefservice.com
          <br />
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        <Reveal delay={100} once>
          <div className="relative overflow-hidden rounded-2xl border border-[var(--hef-border)] bg-white/90 p-5 transition duration-700 hover:-translate-y-[2px] hover:shadow-[0_12px_44px_rgba(0,0,0,.12)]">
            <span
              aria-hidden
      ...
      <Reveal delay={200} once>
        <div className="mt-8 rounded-2xl border border-[var(--hef-border)] bg-[var(--hef-surface)]/70 p-4 text-[13px] text-[var(--hef-dim)] transition duration-700">
