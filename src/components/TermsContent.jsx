  ...
  return (
    <main className="relative">
      ...
      <section className="shell py-12 md:py-14">
        ...
        {/* Карточки условий */}
        <div className="mb-8 2xl:flex 2xl:justify-center">
          <div className="w-full 2xl:max-w-[1200px] grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            <Reveal>
              <Card
            ...
            <Reveal delay={240}>
              <Card
                title="Без комиссии"
                text="Мы не удерживаем комиссию (С нашей стороны комиссии нет по умолчанию. Специальные каналы/платёжные системы обсуждаем отдельно.)."
              />
            </Reveal>
        ...
        <Reveal>
          <div className="2xl:flex 2xl:justify-center">
            <div className="w-full 2xl:max-w-[1000px] rounded-2xl border border-[var(--hef-border)] bg-white/80 shadow-[0_6px_24px_rgba(0,0,0,.05)] p-5 md:p-6">
              <h2 className="text-lg md:text-xl font-semibold mb-4">
                Краткие условия
              </h2>
              <ol className="list-decimal pl-5 space-y-3 text-[15px] leading-relaxed text-[var(--hef-ink)]">
                <li>
                  <b>Состояние SIM.</b> Карта должна позволять совершать
                  исходящие звонки, SMS и приём вызовов/сообщений при
                  положительном балансе. Обязательна возможность регистрации в
                  сети и в регионах назначения (включая 2G). Карта, которая не
                  заходит в сеть, считается неисправной.
                </li>
                <li>
                ...
                <li>
                  ...
                  через эскроу/гарантийные сервисы. Расходы по таким сервисам —
              ...
              <p className="mt-4 text-[13px] text-[var(--hef-dim)]">
                <b>Важно.</b> Настоящий раздел содержит краткое описание. В
                случае расхождений приоритет имеет полная версия условий.
              </p>
            </div>
          </div>
        </Reveal>
        ...
        <Reveal delay={120}>
          <div className="mt-10 2xl:flex 2xl:justify-center">
            <div className="text-center w-full 2xl:max-w-[1000px]">
              <div className="flex flex-col items-center">
                <a
                  href="https://buysim.hefservice.com"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-xl bg-[var(--hef-accent)] px-5 py-3 text-white font-semibold transition hover:opacity-90 max-w-sm w-full justify-center"
                >
...
function Card({ title, text }) {
  return (
    <div className="rounded-2xl border border-[var(--hef-border)] bg-white/90 p-5 shadow-[0_6px_24px_rgba(0,0,0,.05)] transition hover:shadow-[0_10px_36px_rgba(0,0,0,.08)]">
      ...
      <p className="text-[14px] text-[var(--hef-dim)] leading-relaxed">
        {text}
      </p>
    </div>
  );
